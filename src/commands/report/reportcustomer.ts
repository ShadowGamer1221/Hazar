...
class ReportcustomerCommand extends Command {
    constructor() {
        super({
            trigger: 'reportcustomer',
            description: 'Reports a customer.',
            type: 'ChatInput',
            module: 'report',
            args: [
              {
  ...
  let channelSend: TextChannel;
        channelSend = await discordClient.channels.fetch('945381988012023819') as TextChannel;
...
export default ReportcustomerCommand;
